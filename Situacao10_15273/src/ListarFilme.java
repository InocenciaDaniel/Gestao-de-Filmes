...
/* Descrição : classe responsavel por apresentar todos as informações que estão dentro de do ficheiro filme.dat
/*********************************************************************************************/
import java.io.*;
...
public class ListarFilme extends JFrame{
	private JPanel painel = new JPanel();
    private List Lista = new List(10,false);
    private String nome ;
    private long  tamanhoRG = 0;
    
	public ListarFilme() throws Exception
	{
